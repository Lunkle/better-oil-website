    ...
    <div className="min-h-screen bg-brand-white flex flex-col font-sans">
          ...
          {content.kpi.items.map((item, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="text-base md:text-xl font-medium opacity-90 whitespace-pre-wrap">
                  {item.label}
                </div>
              </div>
            );
      ...
      <section className="py-20 md:py-36 px-6 w-full relative bg-gray-100 md:bg-linear-to-r from-gray-100 from-[50.5%] to-brand-white to-[50.5%]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 relative z-10 gap-16 md:gap-0">
          <div className="flex flex-col justify-center pr-0 md:pr-12 relative z-20">
            <h3 className="text-3xl font-bold text-brand-deep-blue mb-8">
            ...
            <ul className="space-y-6">
              {content.problemSolution.leftPoints.map((point, idx) => (
                <li
                  key={idx}
                  className="flex items-start gap-4 text-brand-red font-medium text-lg"
                >
          ...
          <div className="md:pl-28 md:pr-0 flex flex-col justify-start relative z-10">
            ...
            <p className="text-gray-600 text-xl leading-relaxed">
              {content.problemSolution.rightSummary}
            </p>
          </div>
        </div>
      </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-100 text-brand-deep-blue">
                  <th className="p-6 font-bold border-b border-gray-200">
                    {content.comparison.headers[0]}
                  </th>
                  <th className="p-6 font-bold border-b border-gray-200">
                    {content.comparison.headers[1]}
                  </th>
                  <th className="p-6 font-bold border-b-2 border-brand-orange bg-blue-50/50 text-brand-orange">
              ...
              <tbody>
                {content.comparison.rows.map((row, idx) => (
                  ...
                  >
                    ...
                    <td className="p-6 text-gray-500 whitespace-pre-wrap">
                      {row.trad}
                    </td>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-square w-full bg-brand-white border-16 border-brand-white shadow-2xl flex items-center justify-center overflow-visible">
            {/* 3D Drill Bit Image */}
            <Image
      ...
      <section className="py-20 bg-brand-deep-blue text-white px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative aspect-9/2 w-full max-w-7xl mx-auto overflow-hidden flex items-center justify-center mb-4">
            <Image
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {content.diagram.items.map((item, idx) => (
              <DecoratedRectangle
                key={idx}
                className="bg-brand-deep-blue space-y-2"
              >
                <h4 className="text-xl font-bold text-brand-orange">
                  {item.title}
                </h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative max-w-5xl mx-auto flex flex-col items-center justify-center">
            ...
            <div className="relative w-full aspect-square md:aspect-video flex items-center justify-center mb-16 md:mb-0">
              ...
              <div className="relative z-10 border-brand-white shadow-2xl bg-brand-white p-2">
                Add Image here
              </div>
                ...
                return (
                  ...
                  >
                    <div className="bg-white shadow-xl border border-gray-100 p-5 relative">
                      <h4 className="text-xl font-bold text-brand-deep-blue mb-2">
                        {step.label}
                      </h4>
              ...
              <tbody>
                {content.businessScope.subGroups.map((subGroup, groupIdx) =>
                  subGroup.items.map((item, itemIdx) => {
                    ...
                    const totalItems = content.businessScope.subGroups.reduce(
                    ...
                    return (
                      ...
                      >
                        {isFirstOverall && (
                          <td
                            rowSpan={totalItems}
                            className="p-6 font-bold text-xl text-white bg-brand-deep-blue w-48 text-center border-r border-brand-deep-blue/20 align-middle"
                          >
                        ...
                        {isFirstItemInGroup && (
                          <td
                            ...
                            className="p-6 font-bold text-brand-deep-blue bg-blue-50/30 border-r border-gray-100 w-56 align-middle"
                          >
                            {subGroup.name}
                          </td>
                        )}
...
function DecoratedRectangle({
  ...
  return (
    <div className="relative flex-1 flex flex-col group">
      ...
      {/* Main Card */}
      <div
        className={`relative z-10 border border-brand-white/50 p-8 size-full shadow-lg ${className ?? ""}`}
      >
        {children}
      </div>
    </div>
