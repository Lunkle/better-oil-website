    ...
    <main className="min-h-screen bg-brand-white pt-20">
      <Navbar nav={t.nav} navToggle={t.navToggle} currentLang={locale} />
        <div className="max-w-7xl mx-auto px-4 py-20">
          <h1 className="text-4xl md:text-6xl font-bold text-center text-brand-deep-blue uppercase tracking-tighter">{t.nav.find((item) => item.href === "/resource-cooperation")?.name}</h1>
